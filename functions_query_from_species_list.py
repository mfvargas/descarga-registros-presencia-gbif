...
# This file has been written by Marie Grosjean (https://github.com/ManonGros)
# https://github.com/ManonGros/Small-scripts-using-GBIF-API/blob/master/query_species_list/functions_query_from_species_list.py
...
def match_species(species_list, # pandas table
    ...
    the GBIF taxonomy.
    ----
    The alternative matches are also included in the output file (they
    ...
    for species in species_list.index:
        ...
        if match.ok:
            ...
            # The following block is commented in order to obtain just one species per input species
    ...
    taxon_keys = ['usageKey', 'kingdomKey', 'phylumKey','classKey', 'orderKey', 'familyKey', 'genusKey', 'speciesKey']
